...
<form id="orderForm" class="hide" action="/order/create.html" method="post">
	...
	<input type="hidden" name="orderShipping.receiverName" value="武霞"/>
	<input type="hidden" name="orderShipping.receiverMobile" value="18279185290"/>
	<input type="hidden" name="orderShipping.receiverState" value="广东"/>
	<input type="hidden" name="orderShipping.receiverCity" value="深圳"/>
	<input type="hidden" name="orderShipping.receiverDistrict" value="龙岗区"/>
	<input type="hidden" name="orderShipping.receiverAddress" value="方兴科技园"/>
</form>
